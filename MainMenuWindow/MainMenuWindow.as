...
function onLoad() {
	DockInit();
	DistributedValue.SetDValue("UnkBar_Height", 1);
	...
	m_InvisibleButton=attachMovie("InvisibleButton", "m_InvisibleButton", getNextHighestDepth());
...
function UpdateMainMenuItems():Void
{
    ...
    SetupMenuItem("CharacterSheetButton", "character_sheet", "CharacterSheetHandler", m_TDB_CharacterSheet + " (<variable name='hotkey:Toggle_SP_Character'/ >)");
    SetupMenuItem("SkillHiveButton", "skillhive_window", "AnimaWheelHandler", m_TDB_AbilityWheel + " (<variable name='hotkey:Toggle_SkillHive'/ >)");
    SetupMenuItem("CharacterPointsButton", "character_points_gui", "CharacterSkillPointsHandler", m_TDB_CharacterSkillPoints + " (<variable name='hotkey:Toggle_CharacterPoints'/ >)");
    SetupMenuItem("InventoryButton", "inventory_visible", "InventoryHandler", m_TDB_Inventory + " (<variable name='hotkey:Toggle_InventoryView'/ >)");
    SetupMenuItem("JournalButton", "mission_journal_window", "JournalHandler", m_TDB_Journal + " (<variable name='hotkey:Toggle_MissionJournalWindow'/ >)");
    SetupMenuItem("PvPButton", "pvp_minigame_window", "PvPHandler", m_TDB_PvP + " (<variable name='hotkey:Toggle_PvPStatWindow'/ >)");
    SetupMenuItem("AchievementButton", "achievement_lore_window", "AchievementHandler", m_TDB_Achievement + " (<variable name='hotkey:Toggle_AchievementWindow'/ >)");
    SetupMenuItem("CraftingButton", "CraftingWindow", "CraftingHandler", m_TDB_Crafting + " (<variable name='hotkey:Toggle_CraftingWindow'/ >)");
    SetupMenuItem("FriendsButton", "friends_window", "FriendsHandler", m_TDB_Friends + " (<variable name='hotkey:Toggle_FriendsView'/ >)");
    SetupMenuItem("LookingForGroupButton", "group_search_window", "LFGHandler", m_TDB_LFG + " (<variable name='hotkey:Toggle_GroupSearchWindow'/ >)");
    SetupMenuItem("CabalButton", "guild_window", "CabalHandler", m_TDB_Cabal + " (<variable name='hotkey:Toggle_GuildWindow'/ >)");
	SetupMenuItem("LockoutButton", "lockoutTimers_window", "LockoutHandler", m_TDB_Lockouts + " (<variable name='hotkey:Toggle_LockoutWindow'/ >)");
	SetupMenuItem("PetButton", "petInventory_window", "PetHandler", m_TDB_Pets + " (<variable name='hotkey:Toggle_PetWindow'/ >)");
    
    if ( allowedToReceiveItems )
    {
        SetupMenuItem("ClaimButton", "claim_window", "ClaimHandler", m_TDB_Claim);
    }
    
    SetupMenuItem("BrowserButton", "web_browser", "BrowserHandler", m_TDB_WebBrowser + " (<variable name='hotkey:Toggle_Browser'/ >)");
    SetupMenuItem("HelpButton", "petition_browser", "PetitionHandler", m_TDB_Help);
    
    SetupMenuItem("ShopButton", "itemshop_window", "ShopHandler", m_TDB_Shop + " (<variable name='hotkey:Toggle_ItemShop'/ >)", allowedToReceiveItems, m_TDB_Shop_DisabledTooltip);
    
    var enableChronicle:Number = com.GameInterface.Utils.GetGameTweak("GUIEnableChronicle");
    if (enableChronicle != 0) 
    {
        SetupMenuItem("LeaderboardsButton", "leaderboards_browser", "LeaderboardsHandler", m_TDB_Leaderboards + " (<variable name='hotkey:Toggle_Leaderboards'/ >)");
    }

	SetupMenuItem("SettingsButton", null, "UnkBarHandler", "UnkBar Settings");
    SetupMenuItem("SettingsButton", null, "SettingsHandler", m_TDB_Settings + " (<variable name='hotkey:Toggle_Options'/ >)");
    SetupMenuItem("ExitButton", null, "ExitHandler", m_TDB_Exit);
}

//Setup Menu Item
function SetupMenuItem(name:String, distributedValue:String, eventHandler:String, label:String, enable:Boolean, disabledTooltip:String):Void
{
	if (enable == undefined)
	{
		enable = true;
    ...
    var item=attachMovie(name, "m_"+name, getNextHighestDepth());
	item._visible=false;
...
//	item.m_TextField.embedFont=true;
	item.disableFocus = true;
//	item.m_TextField.setNewTextFormat(new TextFormat(STANDARD_FONT, FONT_SIZE, COLOR, true));
...
function Layout():Void
{
    ...
    var baseSize:Number = m_BackgroundBar._height-5;
	DistributedValue.SetDValue("UnkBar_Height", baseSize);
    
    m_MenuIcon._xscale = m_MenuIcon._yscale = baseSize * 0.80;
...
function UnkBarHandler():Void
{
    DistributedValue.SetDValue("UnkBar_Window", true);
    MainMenuReleaseEventHandler();
}
